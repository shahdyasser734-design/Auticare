  ...
  useEffect(() => {
    const loadDoctors = async () => {
      try {
        ...
        const rawDoctorList = Array.isArray(data) ? data : 
        ...
        const doctorList = rawDoctorList.filter(s => s.type === 'doctor');
  ...
  return (
    <MainLayout>
      <div className="space-y-8">
        {/* Hero Section */}
        <div className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-blue-600 via-blue-500 to-cyan-500 px-6 py-16 sm:px-8 sm:py-20 dark:from-blue-900 dark:via-blue-800 dark:to-cyan-900">
          <div className="relative z-10">
            <h1 className="text-4xl font-bold text-white sm:text-5xl">
              Our Pediatric Doctors
            </h1>
            <p className="mt-4 text-lg text-blue-100">
              Connect with specialized pediatric neurologists and medical professionals dedicated to your child's health and development.
            </p>
          </div>
        ...
        <div className="space-y-6">
          <div className="relative">
            <input
              ...
              className="w-full rounded-2xl border border-slate-300 bg-white px-6 py-4 text-slate-900 shadow-lg outline-none transition-all duration-200 placeholder:text-slate-400 focus:border-blue-500 focus:ring-4 focus:ring-blue-200 dark:border-slate-700 dark:bg-slate-900 dark:text-white dark:placeholder:text-slate-500 dark:focus:border-blue-400 dark:focus:ring-blue-500/30"
            />
            <svg
        ...
        {loading ? (
          <div className="flex items-center justify-center py-12">
            <div className="text-center">
              ...
              <p className="text-slate-600 dark:text-slate-400">Loading doctors...</p>
            </div>
          </div>
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {filteredDoctors.map((rawDoctor) => {
              ...
              return (
                <div
                  key={doctor.id}
                  className="group overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-md transition-all duration-300 hover:border-blue-400 hover:shadow-2xl dark:border-slate-700 dark:bg-slate-800 dark:hover:border-blue-500"
                >
                  <div className="aspect-video overflow-hidden bg-gradient-to-br from-blue-100 to-cyan-100 dark:from-blue-900/30 dark:to-cyan-900/30">
                    {doctor.profileImage ? (
                      <img
                  ...
                  <div className="space-y-4 p-5">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        ...
                        <div className="rounded-lg bg-cyan-50 px-3 py-2 dark:bg-cyan-900/30">
                          <p className="text-xs font-medium text-slate-600 dark:text-slate-400">
                            Cases
                          </p>
                          <p className="font-semibold text-slate-900 dark:text-white">
                    ...
                    <div className="flex gap-2 pt-2">
                      <button
                        onClick={() => navigate(`/parent/doctors/${doctor.id}`)}
                        className="flex-1 rounded-full border border-blue-300 px-4 py-2 text-sm font-semibold text-blue-600 transition-colors duration-200 hover:bg-blue-50 dark:border-blue-700 dark:text-blue-400 dark:hover:bg-blue-900/30 cursor-pointer"
                      >
                        View Profile
                      </button>
                      <button
                        ...
                        className="flex-1 rounded-full bg-gradient-to-r from-blue-600 to-cyan-600 px-4 py-2 text-sm font-semibold text-white shadow-md transition-all duration-200 hover:from-blue-700 hover:to-cyan-700 dark:from-blue-700 dark:to-cyan-700 cursor-pointer"
                      >
                        Book Appointment
                      </button>
                    </div>

    ...
    <MainLayout>
      <div className="space-y-8">
        ...
        <div className="grid md:grid-cols-2 xl:grid-cols-3 gap-6">
          ...
          <Card
            hoverable
            onClick={() => navigate(ROUTES.PARENT_MY_BOOKINGS)}
            className="cursor-pointer"
          >
            <div className="text-4xl mb-3">🗓️</div>
            <h3 className="font-bold text-lg mb-2">My Bookings</h3>
            <p className="text-neutral-600 mb-4">
              Review your upcoming and past specialist sessions.
            </p>
            <Button size="sm" fullWidth>
              View Bookings
            </Button>
          ...
          >
            <div className="text-4xl mb-3">📊</div>
            <h3 className="font-bold text-lg mb-2">Screening Dashboard</h3>
            <p className="text-neutral-600 mb-4">
              Check your latest screening dashboard and insights
            </p>
            <Button size="sm" fullWidth>
              View Dashboard
            </Button>
